...
internal struct AnyCodableValueTests {
    ...
    private func initialisation() {
        ...
        let data = Data([00, 11, 22, 33, 44, 55])
    ...
    private func encodeDecodeDouble() throws {
        ...
        let plistDecoded = try PropertyListDecoder().decode([String: AnyCodableValue].self, from: plistData)
        #expect(plistDecoded["double"] ==
            .double(double)) // This is normal, as AnyCodableValue tries decoding float first
    }
    ...
    private func dictionaryValue() {
        ...
        #expect(AnyCodableValue.dictionary([12_345: .string("example")])
            .dictionaryValue == [12_345: .string("example")])
    ...
    private func debugDescription() {
        ...
        #expect(AnyCodableValue.unsignedInteger64(.max)
            .debugDescription == #".unsignedInteger64(18446744073709551615)"#)
